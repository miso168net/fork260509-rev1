...
<!-- SPECKIT START -->
**Active Spec**: [`specs/044-observability-and-cleanup-pass/spec.md`](specs/044-observability-and-cleanup-pass/spec.md)
**Active Plan**: [`specs/044-observability-and-cleanup-pass/plan.md`](specs/044-observability-and-cleanup-pass/plan.md)
**Phase**: plan complete — ready for `/speckit-tasks`
**下一步**: 044 收尾後接 P3 F-facade-atomicity-pass 或 base-web id 型別債 sprint
<!-- SPECKIT END -->
