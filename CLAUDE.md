...
<!-- SPECKIT START -->
**Active Spec**: —（045 facade-atomicity-pass 已 merge、見 `docs/INTEGRATION-CHECKLIST.md` 已完成里程碑）
**Active Plan**: —
**Phase**: idle
**下一步**: base-web TS `id` 型別債 cleanup sprint 或其他 follow-up backlog（042-N1 / 044-N1 / 045-N1 / 045-N2 / W-F15/16）
<!-- SPECKIT END -->
