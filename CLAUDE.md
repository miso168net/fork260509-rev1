...
<!-- SPECKIT START -->
**Active Spec**: [specs/040-wire-id-consistency/spec.md](specs/040-wire-id-consistency/spec.md)
**Active Plan**: [specs/040-wire-id-consistency/plan.md](specs/040-wire-id-consistency/plan.md)
**Phase**: 設計中 — brainstorm(`docs/superpowers/040-feature-wire-id-consistency.md`, Q1-Q3 拍板 A+B+C+D 全包 / Full D wire DTO wrap / 短名 wire-id-consistency) + spec(16/16 quality 全 PASS, 0 NEEDS CLARIFICATION) + clarify(0 修改, 10/10 categories 全 Clear) + plan(Constitution Check 5/5 PASS, Phase 0 research R-Q1~R-Q5 resolved, Phase 1 design 完成 data-model + contracts + quickstart);待 `/speckit-tasks`
