...
<!-- SPECKIT START -->
**Active Spec**: [`specs/047-sandbox-protect-route-fix/spec.md`](specs/047-sandbox-protect-route-fix/spec.md)
**Active Plan**: [`specs/047-sandbox-protect-route-fix/plan.md`](specs/047-sandbox-protect-route-fix/plan.md)
**Phase**: plan complete — ready for `/speckit-tasks`
**下一步**: 047 收尾後接 base-web TS id 型別債 cleanup sprint
<!-- SPECKIT END -->
