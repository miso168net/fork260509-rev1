...
<!-- SPECKIT START -->
**Active Spec**: [`specs/041-spec-hygiene-pass-1/spec.md`](specs/041-spec-hygiene-pass-1/spec.md)
**Active Plan**: [`specs/041-spec-hygiene-pass-1/plan.md`](specs/041-spec-hygiene-pass-1/plan.md)
**Phase**: plan complete — ready for `/speckit-tasks`
**下一步**: 041 收尾後接 R3（HTTP middleware audit gap）→ W-F12/13/14（observability）
<!-- SPECKIT END -->
