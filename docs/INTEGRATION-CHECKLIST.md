...
**Active feature**：—（041 spec-hygiene-pass-1 已完成、見已完成里程碑）

**下一步**：R3（HTTP middleware audit gap）—— 修完後 R2 失敗登入 audit 應自動有；R3 為 F2.2 上游 prerequisite。隨後再續 W-F12/13/14 observability。
